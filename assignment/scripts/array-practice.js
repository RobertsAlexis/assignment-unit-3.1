...
let favoriteFoods = ['Cheese', 'bread', 'fruit'];
...
console.log('Number of favoriteFoods:', numberOfFoods);
...
console.log('the last animal', lastAnimal);
...
console.log('Added an entre to the beginning: ${favoriteFoods}')
...
console.log('reassigned first color', firstColor);
console.log('updated list', colors);
